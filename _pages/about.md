...
<img src="https://quickchart.io/chart?c={type:'bar',data:{labels:['2019','2020','2021','2022','2023','2024','2025'],datasets:[{label:'Citations',data:[17,33,92,112,143,272,557],backgroundColor:'rgba(0,118,223,0.8)',borderRadius:2}]},options:{plugins:{legend:{display:false},title:{display:true,text:'Citations (Total: 1,252)',font:{size:11,weight:'bold'}},datalabels:{display:true,anchor:'end',align:'top',font:{size:8,weight:'bold'}}},scales:{y:{beginAtZero:true,grid:{display:false},ticks:{font:{size:9}}},x:{grid:{display:false},ticks:{font:{size:9}}}}}}&w=350&h=180&bkg=white" alt="Citation Trend" style="width: 100%; max-width: 350px;">
